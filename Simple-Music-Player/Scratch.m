...
//    //    NSRange songsRange = NSMakeRange(location, searchArray.count);
//    
//    
...
//    NSArray *searchAlbumsArray = [albumsSearchQuery items];
//    //    NSRange albumsRange = NSMakeRange(location + songsRange.length, searchAlbumsArray.count);
//    
//    //    searchArray = [searchArray arrayByAddingObjectsFromArray:searchAlbumsArray];
//    
...
//    }
//    
//    //    NSArray *rangeArray = @[[NSValue valueWithRange:songsRange], [NSValue valueWithRange:albumsRange]];
//    NSDictionary *searchDictionary = @{@"category":@"Search",
//                                       @"array": searchArray,
//                                       @"sections": @[searchArray, searchAlbumsArray],
//                                       @"indexHeaderTitles":@[@"Songs", @"Albums"]
//                                       };
//    
...
//        NSArray *array = sectionsArray[section];
//        number = array.count;
//        
//    }
//    else {
...
//{
//    if ([self.mediaItemsDictionary[@"category"] isEqualToString:@"Search"]) {
//        return self.mediaItemsDictionary[@"indexHeaderTitles"];
//    }
//    else{
//        NSArray *sectionsArray= self.mediaItemsDictionary[@"sections"];
//        if (sectionsArray.count > 4||[self.mediaItemsDictionary[@"category"] isEqualToString:@"Search"]) {
...
//    NSRange range;
//    if ([self.mediaItemsDictionary[@"category"] isEqualToString:@"Search"]) {
//        range = [self.mediaItemsDictionary[@"sections"][indexPath.section] rangeValue];
//    }
//    else {
//        range = querySection.range;
//    }
//    NSUInteger adjustIndex =  range.location + indexPath.row;
//    
//    if (mediaTypeString) {
//        
