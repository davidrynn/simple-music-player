...
- (void)viewDidLoad {
    ...
    [self.musicPlayerController setQueueWithItemCollection:self.artistCollection];
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    self.songs = [[self.artistCollection items] sortedArrayUsingDescriptors:@[albumSort, songSort]];
